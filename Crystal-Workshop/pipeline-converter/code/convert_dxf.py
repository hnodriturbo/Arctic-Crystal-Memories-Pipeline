...
def main():
    ...
    parser.add_argument("--formats", nargs="+", default=["xyz"], choices=["xyz", "ply", "obj", "stl", "glb"],
    ...
    parser.add_argument("--texture-plane", choices=["auto", "xy", "xz", "yz"], default="auto")
    ...
    points = parse_dxf_points_fast(file_path, limit=args.limit, scale=args.scale, sample_rate=args.sample_rate)
    ...
    output_paths = write_selected_formats(
        ...
        texture_from=args.texture_from, texture_plane=args.texture_plane, flip_u=args.flip_u, flip_v=args.flip_v
    )
    options = {
