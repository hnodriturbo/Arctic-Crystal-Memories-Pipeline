...
const IS = {
  ...
  "Create a new collection…": "Búa til nýtt safn…",
  "New collection name": "Heiti nýs safns",
  "Create collection": "Búa til safn",
  "Collection created.": "Safn búið til.",
  "Keep the original design dimensions, or choose one fixed size for all selected designs.": "Halda upprunalegum málum hönnunarinnar eða velja eina fasta stærð fyrir allar valdar hannanir.",
  "Width compared with height: 16:9 is landscape, 9:16 is portrait, 1:1 is square and 4:5 is a portrait feed post.": "Breidd miðað við hæð: 16:9 er lárétt, 9:16 er lóðrétt, 1:1 er ferningur og 4:5 er lóðrétt færsla.",
  "The number of pixels in the video. More pixels preserve more detail but take longer to render. Upscaling does not create missing detail.": "Fjöldi punkta í myndbandinu. Fleiri punktar varðveita meiri smáatriði en taka lengri tíma í vinnslu. Stækkun býr ekki til smáatriði sem vantar í frumgerðina.",
  "Frames per second. 60 fps gives smoother motion; 30 fps renders fewer frames; 24 fps has a film-like cadence. Rendering time is not guaranteed to halve.": "Rammar á sekúndu. 60 fps gefur mýkri hreyfingu; 30 fps vinnur færri ramma; 24 fps gefur kvikmyndatakt. Vinnslutíminn helmingast ekki endilega.",
  "CRF controls compression, not resolution. Workshop defaults to 18; x264 defaults to 23. Lower values retain more detail and make larger files. 18: high quality, a useful starting point. 10: very little compression, much larger files. 5: even less compression, often little visible improvement over 10. 25: smaller files, with more risk of visible artefacts around text and motion. 0 is lossless; 51 is the lowest quality. There is no single best value or fixed file size: compare a short render at the intended viewing size.": "CRF stjórnar þjöppun, ekki upplausn. Sjálfgefið í Workshop er 18; sjálfgefið í x264 er 23. Lægri tala varðveitir meiri smáatriði og gefur stærri skrár. 18: mikil gæði, gott upphafsgildi. 10: mjög lítil þjöppun og mun stærri skrár. 5: enn minni þjöppun, oft lítill sýnilegur munur frá 10. 25: minni skrár en meiri hætta á sýnilegri bjögun við texta og hreyfingu. 0 er taplaust; 51 eru minnstu gæðin. Ekkert eitt gildi er algilt og skráarstærðin er ekki föst: berðu saman stutta prufu í þeirri stærð sem á að horfa á myndbandið.",
  "Render only this many seconds from the start. Leave blank for the whole animation. Use a short test to compare quality and framing.": "Vinna aðeins þennan fjölda sekúndna frá upphafi. Auður reitur merkir alla hreyfimyndina. Notaðu stutta prufu til að bera saman gæði og rammaskurð.",
  "Scale the website address in the final scene. 1 means its original size; 1.6 means 160%. This does not enlarge the whole video.": "Stækka veffangið í lokasenunni. 1 er upprunaleg stærð; 1,6 er 160%. Þetta stækkar ekki allt myndbandið.",
  "Choose a collection for the finished video, or create a new one. Design sources stay in their original collection.": "Veldu safn fyrir tilbúna myndbandið eða búðu til nýtt. Frumskrár hönnunarinnar haldast í sínu upprunalega safni.",
  "Cockpit Reconstruct": "Cockpit Endurbygging",
  "Saved scenes · every point · textured GLB": "Vistaðar Senur, hver punktur, Textúrað GLB",
  "Workshop home": "Forsíða Workshop",
  "Choose a workspace to begin.": "Veldu hluta til að byrja.",
  "Choose a tool in this workspace.": "Veldu verkfæri í þessum hluta.",
  "Open workspace": "Opna hluta",
  "Part": "Partur",
  ...
  "In ccm-workshop": "Í ccm-workshop",
  "Fetch": "Sækja niður",
  ...
  "Preview": "Forskoðun",
  "Refresh": "Endurnýja",
  "Reading the design library…": "Les hönnunarsafnið…",
  "Sign in again to read the design library.": "Skráðu þig inn aftur til að lesa hönnunarsafnið.",
  "No designs found in this folder.": "Engar hannanir fundust í þessari möppu.",
  "Choose a design to look at it before rendering.": "Veldu hönnun til að skoða hana áður en renderað er.",
  "Select": "Velja",
  "Select every design in this collection": "Velja allar hannanir í þessu safni",
  "Upload this collection to ccm-workshop": "Hlaða þessu safni upp í ccm-workshop",
  "This machine can render": "Þessi vél getur renderað",
  "Chromium is missing - rendering is unavailable": "Chromium vantar — ekki hægt að rendera",
  "ffmpeg is missing - rendering is unavailable": "ffmpeg vantar — ekki hægt að rendera",
  "ccm-workshop is not configured": "ccm-workshop er ekki uppsett",
  "Nothing local yet - fetch a collection from R2 first": "Ekkert staðbundið enn — sæktu safn úr R2 fyrst",
  "Video settings": "Myndbandsstillingar",
  "Frame size": "Rammastærð",
  "As each design specifies": "Eins og hönnunin segir til um",
  "One size for all of them": "Ein stærð fyrir allar",
  "Resolution": "Upplausn",
  "Frame rate": "Rammatíðni",
  "half the time": "helmingi fljótara",
  "film": "kvikmynd",
  "Quality (CRF)": "Gæði (CRF)",
  "Lower is better and larger.": "Lægra gildi = betri gæði og stærri skrá.",
  "Test length": "Prufulengd",
  "whole animation": "öll hreyfimyndin",
  "Seconds. Check the look before committing an hour.": "Sekúndur. Prófaðu útlitið áður en þú leggur klukkutíma í keyrsluna.",
  "Closing www.ccm.is": "Lokasenan — www.ccm.is",
  "Size multiplier in the last scene.": "Stækkunarstuðull í lokasenunni.",
  "Save into collection": "Vista í safn",
  "same as the design's": "sama og hönnunin",
  "Keep the player bar at the bottom of the video": "Hafa spilarastikuna sýnilega neðst í myndbandinu",
  "Off by default. It belongs to the design's own preview, not to a finished video.": "Sjálfgefið slökkt. Stikan tilheyrir forskoðun hönnunarinnar, ekki tilbúnu myndbandi.",
  "Render video": "Búa til myndband",
  "Render": "Rendera",
  "videos": "myndbönd",
  "selected": "valdar",
  "Rendering needs ffmpeg and Chromium on this machine.": "Render þarf ffmpeg og Chromium á þessari vél.",
  "Could not start the render.": "Tókst ekki að hefja render.",
  "could not be queued": "komust ekki í röð",
  "Render queue": "Render-röð",
  "waiting": "bíða",
  "Clear finished": "Hreinsa kláruð",
  "Nothing has been rendered in this session.": "Ekkert hefur verið renderað í þessari lotu.",
  "min left": "mín eftir",
  "queued": "í röð",
  "uploading": "hleð upp",
  "done": "lokið",
  "error": "villa",
  "cancelled": "hætt við",
  "Rendered videos": "Tilbúin myndbönd",
  "Nothing stored in ccm-workshop yet.": "Ekkert vistað í ccm-workshop enn.",
  "Download": "Sækja",
  "Delete": "Eyða",
  "Delete from R2": "Eyða úr R2",
  "Deleted from R2.": "Eytt úr R2.",
  "Could not delete it.": "Tókst ekki að eyða.",
  "source": "frumskrá",
  "standalone": "sjálfstæð",
  "Fetching from R2…": "Sæki úr R2…",
  "Uploading to R2…": "Hleð upp í R2…",
  "The sync failed.": "Samstillingin mistókst.",
  "fetched": "sótt",
  "uploaded": "hlaðið upp",
  "unchanged": "óbreytt",
  ...
  "Every archive here has already been unpacked.": "Öll zip-skjöl hér hafa þegar verið tekin upp.",
  "archives have no folder behind them yet.": "zip-skjölum fylgir engin mappa enn.",
  "of": "af",
  "unpacked": "tekið upp",
  "not unpacked": "ekki tekið upp",
  "Unpack": "Pakka upp",
  "Unpacking…": "Pakka upp…",
  "Unpacked into": "Tekið upp í",
  "Unpacking failed.": "Upptaka mistókst.",
  "Unpacking creates a folder named after the archive. An existing folder is never overwritten.": "Upptaka býr til möppu með sama nafni og zip-skráin. Mappa sem þegar er til er aldrei yfirskrifuð.",
  ...
  "Crystal Workshop": "Crystal Workshop",
