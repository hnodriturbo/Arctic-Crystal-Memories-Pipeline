 ...
 * Purpose: The sidebar's contents - one clear menu for each active
...
export const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      {
        id: "cockpit-reconstruct",
        emoji: "✨",
        label: "Cockpit Reconstruct",
        blurb: "Rebuild exported DXF or CAD points as a colored surface and review the GLB.",
        icon: "cube",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      { id: "r2-browser", label: "R2 File Browser", blurb: "Browse, download and use files from private R2 storage.", icon: "layers" },
      {
        id: "environments",
        emoji: "🐍",
